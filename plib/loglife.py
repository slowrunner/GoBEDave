...
#              to /home/pi/GoBEDave/life.log
#
# with sudo crontab -e
#      @reboot /home/pi/GoBEDave/nohup_loglife.py
# touch /home/pi/GoBEDave/life.log
# chmod 777 /home/pi/GoBEDave/life.log
#
...
loghandler = logging.FileHandler('/home/pi/GoBEDave/life.log')
...
class digitalEntity():
  ...
  def dEmain(self,tSleep=defaultSleep):
    ...
    time.sleep(10)  # wait for network date time sync
    logger.info("------------ boot ------------")
